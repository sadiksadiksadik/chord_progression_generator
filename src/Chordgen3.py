...
from tkinter import *
from Chordgen3variables import *
...
# Print Scale Loop    
    if scale == "Major":
        ...
        progressionbox.delete('1.0', 'end')
        progressionbox.tag_configure("center", justify='center')
        progressionbox.insert('1.0', Ionian_in_thirds, 'center')
...
scale_menu = StringVar(root)
#sets initial name for widget
scale_menu.set("Please Choose a Mode")
dropdownmenu1 = OptionMenu(root, scale_menu,*menu_options)
